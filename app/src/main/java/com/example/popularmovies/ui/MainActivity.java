...
import com.example.popularmovies.adapter.GridViewAdapter;
        ...
        viewModel.getMovies().observe(this, new Observer<List<FavoriteMovie>>() {
            ...
            public void onChanged(@Nullable List<FavoriteMovie> favs) {
                ...
                for (int i=0; i<favMovs.size(); i++) {
                    model = new ModelDataMain(image_url + favMovs.get(i).getImage());
                    arrayList.add(model);
                }
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    model = new ModelDataMain( image_url + jsonObjectMovie.getString( "poster_path" ) );
                    arrayList.add( model );
                }
            } catch (Exception e) {
