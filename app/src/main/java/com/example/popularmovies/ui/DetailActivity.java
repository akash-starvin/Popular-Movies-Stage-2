...
import com.example.popularmovies.adapter.ListViewTrailerAdapter;
import com.example.popularmovies.model.ModelTrailer;
...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView tvYear, tvDuration, tvDescription, tvReviews;
    ImageView imgPoster;
    ListView lvTrailer;
    RatingBar ratingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvYear = findViewById( R.id.tvReleasDate );
    ...
    public class FetchMovieData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                sDuration = jsonObject.getString( "runtime" )+ " mins";
            ...
            try {
                ...
                URL urlTrailer = new URL(BASE_URL + id + "/videos?api_key=" + API_KEY);
            ...
            try {
                ...
                URL urlReviews = new URL(BASE_URL + id + "/reviews?api_key=" + API_KEY);
